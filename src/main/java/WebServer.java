        ...
        try {
            switch (transformation) {
                ...
                case "expandHorizontal":
                    ...
                    break;
                case "moreSepia":
                    transformedPixels = Transform.moreSepia(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "lessSepia":
                    transformedPixels = Transform.lessSepia(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "moreNegative":
                    transformedPixels = Transform.moreNegative(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "lessNegative":
                    transformedPixels = Transform.lessNegative(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "moreGray":
                    transformedPixels = Transform.moreGray(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "lessGray":
                    transformedPixels = Transform.lessGray(pixels,
                            Transform.DEFAULT_COLOR_SHIFT);
                    break;
                case "moreAlpha":
